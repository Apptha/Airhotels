...
class Apptha_Paypaladaptive_Model_Mysql4_Commissiondetails extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        // Note that the refunddetails_id refers to the key field in your database table
        $this->_init('paypaladaptive/commissiondetails', 'Commissiondetails_id');
    }
}