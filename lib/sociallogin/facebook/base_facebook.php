 ...
 */
class SloginFacebookApiException extends Exception
{
  /**
...
abstract class BaseFacebook
{
   ...
   * @throws SloginFacebookApiException
   */
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new SloginFacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new SloginFacebookApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
